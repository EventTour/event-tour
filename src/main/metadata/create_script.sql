...
CREATE TABLE IF NOT EXISTS `eventtour`.`location` (
  ...
  INDEX `fk_country_idx` (`l_country` ASC),
...
CREATE TABLE IF NOT EXISTS `eventtour`.`user` (
  ...
  INDEX `fk_user_role1_idx` (`role_r_id` ASC),
  INDEX `fk_user_profile_idx` (`u_profife` ASC),
  INDEX `fd_default_location_idx` (`u_default_location` ASC),
...
CREATE TABLE IF NOT EXISTS `eventtour`.`event` (
  ...
  `e_info` INT NULL,
  `e_price` INT NULL,
  INDEX `fk_e_location_idx` (`e_location` ASC),
  INDEX `fk_e_owner_idx` (`e_owner` ASC),
  INDEX `fk_info_idx` (`e_info` ASC),
  PRIMARY KEY (`e_id`),
...
CREATE TABLE IF NOT EXISTS `eventtour`.`transfer` (
  ...
  `t_to` INT NULL,
  PRIMARY KEY (`t_id`),
  INDEX `fk_t_owner_idx` (`t_owner` ASC),
  INDEX `fk_t_from_idx` (`t_from` ASC),
  INDEX `fk_t_to_idx` (`t_to` ASC),
  INDEX `fk_t_type_idx` (`t_type` ASC),
...
CREATE TABLE IF NOT EXISTS `eventtour`.`accomodation` (
  ...
  PRIMARY KEY (`a_id`),
  INDEX `fk_a_owner_idx` (`a_owner` ASC),
  INDEX `fk_a_location_idx` (`a_location` ASC),
...
CREATE TABLE IF NOT EXISTS `eventtour`.`wishlist` (
  ...
  INDEX `fk_w_event_idx` (`w_event` ASC),
...
CREATE TABLE IF NOT EXISTS `eventtour`.`purchase` (
  ...
  PRIMARY KEY (`p_user`),
  INDEX `fk_p_event_idx` (`p_event` ASC),
  INDEX `fk_p_transfer_idx` (`p_transfer` ASC),
  INDEX `fk_p_accomodation_idx` (`p_accomodation` ASC),
